...
const AboutButton:React.FC = () => {
  ...
  return (
    <a href="#"className="group relative inline-block overflow-hidden rounded border border-neutral-100 bg-neutral-100  px-12 py-3 text-sm font-medium text-slate-800 focus:outline-none active:bg-green-400 active:opacity-80 active:text-black">
