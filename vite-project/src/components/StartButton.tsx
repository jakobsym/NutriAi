...
const StartButton: React.FC = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center w-90 h-40 mb">
      <button type="button" className="text-white bg-neutral-100 hover:bg-neutral-100 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-black dark:hover:bg-neutral-800">
        Get Started
